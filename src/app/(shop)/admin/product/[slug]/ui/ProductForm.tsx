...
import type { Product, Category, Gender, ProductImage as ProductImageT, Size } from '@/interfaces';
...
export const ProductForm = ({ product, categories }: Props) => {
  ...
  const onSubmit = async ( data: FormInputs ) => {
    ...
    const { ok, product: productUpdated } = await createUpdateProduct(formData)
